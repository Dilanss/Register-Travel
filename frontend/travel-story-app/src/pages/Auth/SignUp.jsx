            ...
            <div className="container h-screen flex items-center justify-center px-20 mx-auto">
                <div className="w-2/4 h-[90vh] flex items-end bg-signup-bg-img bg-cover bg-center rounded-lg p-10 z-50">
                    <div className='text-5xl font-semibold text-white leading-[50px]'>
                        <h4>Join the <br /> Adventure </h4>
                        <p className="text-[15px] text-white leading-6 pr-7 mt-4">
                            Create an account to start docume ntation your travels and preserving your memories in your personal travel journals.
                        </p>
                    </div>
                </div>
                ...
                <div className='w-2/4 h-[75vh] bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/20'>
                    <form onSubmit={handleSignUp}>
                        ...
                        <button type="submit" className='btn-primary'>CREATE COUNT</button>
